...
namespace InventoryManagementSystem
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\22890\Documents\dbMS.mdf;Integrated Security=True;Connect Timeout=30");
